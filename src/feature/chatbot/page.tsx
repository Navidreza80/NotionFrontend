import { BookOpenText, PenSquare, Plus } from "lucide-react";
...
const RecentlyCard = ({ title, icon: Icon, image }) => (
  <div className="w-[124px] h-[118px] overflow-hidden flex items-center justify-center rounded-xl relative border hover:border-[#383838] border-[#2a2a2a] bg-[#2a2a2a] transition shadow-sm">
    ...
    <div className="h-[63%] w-full bg-[#202020]/60 absolute flex items-center px-4 bottom-0 z-50">
      ...
      <main className="flex-1 w-auto px-[5.2px] mt-16 pb-20 max-w-3xl">
          ...
          <div className="mt-5 p-3 pb-1 rounded-2xl border border-[#242424] focus:outline-none focus-within:border-[#383838] transition-all duration-300 bg-[#202020]">
            ...
            <div className="flex items-center justify-between gap-3 pt-2.5">
              <div className="flex items-center gap-1.5">
                <div className="rounded-full flex gap-1 text-[14px] cursor-pointer p-2 hover:bg-[#282828]">
                  <svg
                    aria-hidden="true"
                    role="graphics-symbol"
                    viewBox="0 0 20 20"
                  ...
                  >
                    <path d="M10.184 3.64A3.475 3.475 0 0 1 15.1 8.554l-5.374 5.374a2.05 2.05 0 1 1-2.9-2.9l2.688-2.686a.625.625 0 0 1 .884.884L7.71 11.913a.8.8 0 0 0 1.13 1.131l5.375-5.374a2.225 2.225 0 1 0-3.147-3.146L5.694 9.898a3.65 3.65 0 1 0 5.162 5.161l4.702-4.702a.625.625 0 0 1 .884.884l-4.702 4.702a4.9 4.9 0 1 1-6.93-6.93z"></path>
                  </svg>
                </div>
                <div className="rounded-full flex gap-1 text-[14px] text-[#9f9b94] font-semibold cursor-pointer py-1 px-3 hover:bg-[#282828]">
                  Auto
                </div>
                <div className="rounded-full flex gap-1 text-[14px] text-[#9f9b94] font-semibold cursor-pointer py-1.5 px-2 hover:bg-[#282828]">
                  <svg
                    aria-hidden="true"
                    role="graphics-symbol"
                    viewBox="0 0 20 20"
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between pr-2">
            <div className="text-[12px] font-semibold flex gap-2 text-zinc-500">
              <svg
                aria-hidden="true"
                role="graphics-symbol"
                viewBox="0 0 16 16"
              ...
              >
                <path d="M8 3.955a.625.625 0 0 0-.625.625v2.795H5.12a.625.625 0 1 0 0 1.25H8c.345 0 .625-.28.625-.625V4.58A.625.625 0 0 0 8 3.955"></path>
                <path d="M8 1.875a6.125 6.125 0 1 0 0 12.25 6.125 6.125 0 0 0 0-12.25M3.125 8a4.875 4.875 0 1 1 9.75 0 4.875 4.875 0 0 1-9.75 0"></path>
              </svg>
              Recently visited
            </div>
          </div>
        ...
        {/* Upcoming events */}
        <div className="mt-8">
          <div className="text-[12px] font-semibold flex gap-2 text-zinc-500 mb-3">
            <svg
              aria-hidden="true"
              role="graphics-symbol"
              viewBox="0 0 16 16"
              className="viewCalendarSmall"
              style={{
                width: "14px",
                height: "14px",
                display: "block",
            ...
            >
              <path d="M7.053 6.407a.643.643 0 1 0 0 1.286.643.643 0 0 0 0-1.286m1.894 0a.643.643 0 1 0 0 1.286.643.643 0 0 0 0-1.286m1.893 0a.643.643 0 1 0 0 1.286.643.643 0 0 0 0-1.286M5.159 8.3a.643.643 0 1 0 0 1.287.643.643 0 0 0 0-1.286M7.053 8.3a.643.643 0 1 0 0 1.287.643.643 0 0 0 0-1.286M8.947 8.3a.643.643 0 1 0 0 1.287.643.643 0 0 0 0-1.286M10.84 8.3a.643.643 0 1 0 0 1.287.643.643 0 0 0 0-1.286m-5.681 1.894a.643.643 0 1 0 0 1.286.643.643 0 0 0 0-1.286m1.894 0a.643.643 0 1 0 0 1.286.643.643 0 0 0 0-1.286m1.894 0a.643.643 0 1 0 0 1.286.643.643 0 0 0 0-1.286"></path>
              <path d="M4.25 2.375c-1.036 0-1.875.84-1.875 1.875v7.5c0 1.036.84 1.875 1.875 1.875h7.5c1.036 0 1.875-.84 1.875-1.875v-7.5c0-1.036-.84-1.875-1.875-1.875zm-.625 9.375V5.632h8.75v6.118c0 .345-.28.625-.625.625h-7.5a.625.625 0 0 1-.625-.625"></path>
            </svg>
            Upcoming events
          </div>
                ...
                <div className="flex flex-wrap flex-col items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className=" text-[13px] font-meduim leading-relaxed text-white/30 max-w-[275px]">
                      Join calls, transcribe audio, and summarize meetings all
                      in Notion.
                    </p>
                  </div>
